  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Ringkasan reservasi apartemen</p>
      </div>

      {/* Stats Cards */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-xl p-5 border border-gray-100">
          <p className="text-sm text-gray-400">Total Reservasi</p>
          <p className="text-3xl font-bold text-gray-900 mt-1">{stats?.total || 0}</p>
        </div>
        <div className="bg-white rounded-xl p-5 border border-gray-100">
          <p className="text-sm text-gray-400">Lunas</p>
          <p className="text-3xl font-bold text-green-600 mt-1">{stats?.lunas || 0}</p>
        </div>
        <div className="bg-white rounded-xl p-5 border border-gray-100">
          <p className="text-sm text-gray-400">DP</p>
          <p className="text-3xl font-bold text-yellow-600 mt-1">{stats?.dp || 0}</p>
        </div>
        <div className="bg-white rounded-xl p-5 border border-gray-100">
          <p className="text-sm text-gray-400">Menunggu</p>
          <p className="text-3xl font-bold text-gray-400 mt-1">{stats?.menunggu || 0}</p>
        </div>
      </div>

      {/* Revenue */}
      <div className="bg-gradient-to-r from-[#1a2744] to-[#2a3d5f] rounded-xl p-6 mb-8 text-white">
        <p className="text-white/60 text-sm">Total Pendapatan</p>
